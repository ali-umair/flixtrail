...
@Component({
  selector: 'app-detail',
  imports: [CardComponent, NgIf, NgFor, NgClass],
...
export class DetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.details.media_type == "tv" ? this.genreNames = this.mapGenreIdsToNames(this.genreIds, GENRES_TV) : this.genreNames = this.mapGenreIdsToNames(this.genreIds, GENRES_MOVIES);
    if (this.details.media_type == "tv") {
    ...
    else if (!this.details.media_type || this.details.media_type != "tv") {
